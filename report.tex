...
\begin{figure}[H]
\centering
% INSTRUCTION FOR USER: Insert a UML class diagram showing general, department, expensetype, and expense classes with their attributes, methods, and inheritance/aggregation relationships. Use PlantUML or any UML tool.
\includegraphics[width=0.85\textwidth]{uml_entities.png}
...
\begin{figure}[H]
\centering
% INSTRUCTION FOR USER: Insert a UML class diagram showing accounting, departmentList, expensetypeList, expenseList, generalList, data, dataxml, and their relationships (aggregation, inheritance). Use PlantUML or any UML tool.
...
\begin{figure}[H]
\centering
% INSTRUCTION FOR USER: Insert a UML class diagram showing the GUI class hierarchy: libWidget, dbTableWidget, dbComboBox, editForm, page, departmentsTable, expensetypesTable, expensesTable, departmentEditForm, expensetypeEditForm, expenseEditForm (with departmentCombo and expensetypeCombo), departmentPage, expensetypePage, expensePage, tabWidget, mainWindow. Include their relationships (inheritance, composition).
\includegraphics[width=\textwidth]{uml_gui.png}
...
\begin{figure}[H]
\centering
% INSTRUCTION FOR USER: Insert a screenshot of the main window with the "Отделы" (Departments) tab selected. Show the table of departments and the edit form.
\includegraphics[width=\textwidth]{screenshot_departments.png}
...
\begin{figure}[H]
\centering
% INSTRUCTION FOR USER: Insert a screenshot of the main window with the "Виды расходов" (Expense Types) tab selected. Show the table and edit form for expense types.
\includegraphics[width=\textwidth]{screenshot_expensetypes.png}
...
\begin{figure}[H]
\centering
% INSTRUCTION FOR USER: Insert a screenshot of the main window with the "Расходы" (Expenses) tab selected. Show the table of expenses and the edit form with combo boxes for selecting department and expense type, amount field, and date picker.
\includegraphics[width=\textwidth]{screenshot_expenses.png}
...
\begin{figure}[H]
\centering
% INSTRUCTION FOR USER: Insert a screenshot showing the File > Open XML dialog in action, or the application after successfully loading data from data.xml.
\includegraphics[width=\textwidth]{screenshot_open_xml.png}
...
\begin{figure}[H]
\centering
% INSTRUCTION FOR USER: Insert a screenshot showing the File > Save XML dialog, or the resulting XML file content.
\includegraphics[width=\textwidth]{screenshot_save_xml.png}
